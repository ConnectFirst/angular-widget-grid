...
(function () {
  angular.module('widgetGrid').directive('wgMovable', ['widgetGrid_gridUtil', function (widgetGrid_gridUtil) {
    return {
      restrict: 'A',
      require: 'wgWidget',
      link: {
  ...
  angular.module('widgetGrid').directive('wgMover', ['$document', 'widgetGrid_gridUtil', 'PathIterator', function ($document, widgetGrid_gridUtil, PathIterator) {
    return {
      restrict: 'A',
      require: '^wgGrid',
...
(function () {
  angular.module('widgetGrid').directive('wgResizable', ['widgetGrid_gridUtil', function (widgetGrid_gridUtil) {
    return {
      restrict: 'A',
      require: 'wgWidget',
      link: {
        pre: function (scope, element, attrs, widgetCtrl) {
          // init & append template
          var templateContent = widgetGrid_gridUtil.getTemplate('wg-resizable');
          if (templateContent) {
            var template = angular.element(templateContent);
            element.append(template);
            widgetCtrl.innerCompile(template);
...
(function () {
   ...
   */
  angular.module('widgetGrid').service('widgetGrid_gridUtil', ['$templateCache', function ($templateCache) {
    var service = {
