...
describe('GridRendering', function () {
  ...
  beforeEach(inject(function (_widgetGrid_Grid_, _GridArea_, _GridRendering_, _GridPoint_, _widgetGrid_Widget_) {
    Grid = _widgetGrid_Grid_;
    GridArea = _GridArea_;
    GridRendering = _GridRendering_;
    GridPoint = _GridPoint_;
    Widget = _widgetGrid_Widget_;
